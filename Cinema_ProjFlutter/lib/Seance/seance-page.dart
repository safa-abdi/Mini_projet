...
class _SeancePageState extends State<SeancePage> {
  ...
  Future<List> getAllData() async {
    String url1 = 'http://192.168.100.198:8081/apis/seances';
          ...
          RaisedButton(
            ...
            onPressed: () async {
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => addSeance()));
            },
          ),
        ],
      ),
                          ...
                          child: Row(
                            children: [
                              Container(
                                child: RaisedButton(
                                  color: Colors.white,
                                  child: Text(list[i]['heureDebut'].toString()+""+list[i]['id'].toString(),
